...
$auth_users = array(
    'admin' => '$2y$10$AlUoLpH4HKIcDCINwMeR3.Nz8KNdwlq2AxtPAm2xuQfY98bPJTrK2', //admin@123@
    'user' => '$2y$10$jopPFsk6xWNnMSKTXQzhE.zNdHWnRZpWIpwJpv2WulNmbk5fzOukq', //user1234@
...
$root_path = $_SERVER['DOCUMENT_ROOT']."/".$folderShare;
...
if (isset($_GET['view'])) {
    ...
    $file_url = FM_ROOT_URL . '/' .$folderShare .  fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') .'/'. $file);
    $file_path = $path . '/' . $file;
    echo $file_url;
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                        ...
                        <?php endif; ?>
                        <a title="<?php echo lng('DirectLink')?>" href="<?php echo fm_enc(FM_ROOT_URL . '/' .$folderShare .  (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f . '/') ?>" target="_blank"><i class="fa fa-link" aria-hidden="true"></i></a>
                    </td>
                </tr>
                <?php
                flush();
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php endif; ?>
                        <a title="<?php echo lng('DirectLink') ?>" href="<?php echo fm_enc(FM_ROOT_URL .  '/' .$folderShare . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" target="_blank"><i class="fa fa-link"></i></a>
